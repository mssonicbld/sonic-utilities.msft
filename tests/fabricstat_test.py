...
multi_asic_fabric_counters_queue_nz = """\
  ASIC    PORT    STATE    QUEUE_ID    CURRENT_BYTE    CURRENT_LEVEL    WATERMARK_LEVEL
------  ------  -------  ----------  --------------  ---------------  -----------------
     0       0       up           0             763               12                 20
     0       2       up           0             104                8                  8
...
multi_asic_fabric_counters_queue_nz_asic0 = """\
  ASIC    PORT    STATE    QUEUE_ID    CURRENT_BYTE    CURRENT_LEVEL    WATERMARK_LEVEL
------  ------  -------  ----------  --------------  ---------------  -----------------
     0       0       up           0             763               12                 20
     0       2       up           0             104                8                  8
...
------  -----------  ----------  ----------  -------------  ------------  -----------
 asic0            5           3           8           62.5          None        Never
 asic1            2           1           8           25            None        Never
"""
...
multi_asic_fabric_rate_nonzero = """\
...
class TestFabricStat(object):
    ...
    def test_single_show_fabric_counters_nonzero(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-nz'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_counters_nonzero_asic0
...
class TestMultiAsicFabricStat(object):
    ...
    def test_multi_show_fabric_counters_nonzero(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-nz'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_counters_nonzero

    def test_multi_show_fabric_counters_nonzero_asic(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-nz', '-n', 'asic0'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_counters_nonzero_asic0
    ...
    def test_multi_show_fabric_counters_queue_nonzero(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-q', '-nz'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_counters_queue_nz

    def test_multi_show_fabric_counters_queue_nonzero_asic(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-q', '-nz', '-n', 'asic0'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_counters_queue_nz_asic0
    ...
    def test_multi_show_fabric_isolation_nonzero(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-i', '-nz'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_isolation_nz

    def test_multi_show_fabric_isolation_nonzero_asic(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-i', '-nz', '-n', 'asic0'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_isolation_nz_asic0
    ...
    def test_multi_show_fabric_rate_nonzero(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-s', '-nz'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_rate_nonzero
    ...
    def test_multi_show_fabric_rate_nonzero_asic(self):
        return_code, result = get_result_and_return_code(['fabricstat', '-s', '-nz', '-n', 'asic0'])
        print("return_code: {}".format(return_code))
        print("result = {}".format(result))
        assert return_code == 0
        assert result == multi_asic_fabric_rate_nonzero
